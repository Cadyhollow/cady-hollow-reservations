...
//
// Security PR 5c-1. OWNER-GATED, both verbs — this is the screen that decides who can issue a
// refund, so it sits at the top of the ladder. requireRole is the FIRST statement in each handler,
// before the body is read, because middleware.ts's matcher is ['/admin/:path*'] and never sees
