                        ...
                        try {
                          ...
                          await fetch('/api/email', {
                            ...
                            body: JSON.stringify({
                              ...
                              // Wizard bookings record the money on the FOLIO, not on
                              // reservations.amount_paid — which is why so many rows read 0
                              // there despite the guest having paid. Use the same figure the
                              // panel above displays (amount_paid + selectedFolioPaid),
                              // otherwise a resend reports "Paid Today" as just the card fee.
                              amountPaid: selected.amount_paid + selectedFolioPaid,
