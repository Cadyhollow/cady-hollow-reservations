        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ background: '#fff', borderRadius: 12, padding: '2rem', width: '100%', maxWidth: 520, boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '12px 0' }}>
              <button
                type="button"
                onClick={() => setForm({ ...form, track_inventory: !form.track_inventory })}
                style={{ width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer', backgroundColor: form.track_inventory ? '#15803d' : '#d1d5db', position: 'relative', flexShrink: 0 }}
              >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '12px 0 20px' }}>
              <button
                ...
                style={{ width: 40, height: 22, borderRadius: 11, border: 'none', cursor: 'pointer', backgroundColor: form.active ? '#15803d' : '#d1d5db', position: 'relative', flexShrink: 0 }}
              >
