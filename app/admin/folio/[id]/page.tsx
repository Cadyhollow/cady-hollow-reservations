...
export default function FolioPage() {
  ...
  //
  // The suggested amount is now the full REMAINING refundable, not 90% of the original. The
  // 90% was Cady's cancellation fee, and a folio payment is an add-on, a POS sale, an extra
