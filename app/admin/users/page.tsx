...
//
// Security PR 5c-1. Until now an account existed only because someone with the service key ran
...
// is Owner-gated twice over: middleware.ts refuses it (lib/admin-pages.ts maps /admin/users to
