...
import {
  sortTasks, visibleTasks, openCount, isOverdue, dueLabel, dueDayLabel, initials, nameOf,
  type Task, type Person,
} from '@/lib/tasks'
// Imported here rather than re-exported from '@/lib/tasks' — see the note in that file. Same
// palette as the POS category tiles, hashed from the name so a colour never moves.
import { posTileColor as personColor } from '@/lib/pos-tiles'
