...
export default function NewSeasonalCamperPage() {
  ...
  const previewGuest = {
    ...
    camper_make: rig.camper_make, camper_model: rig.camper_model, camper_year: rig.camper_year as any,
  ...
  const vars = buildContractVars(previewGuest as any, previewContract as any, settings as any)
