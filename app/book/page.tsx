        ...
        <div className="lg:col-span-1">
          <div className="rounded-2xl p-6 sticky top-6" style={{ backgroundColor: '#2B2B2B' }}>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div><p className="text-gray-400">Arrival</p><p className="text-white font-medium">{arrival}</p><p className="text-gray-500 text-xs">Check-in: {settings?.check_in_time || '2:00 PM'}</p></div>
              <div><p className="text-gray-400">Departure</p><p className="text-white font-medium">{departure}</p><p className="text-gray-500 text-xs">Check-out: {settings?.check_out_time || '12:00 PM'}</p></div>
