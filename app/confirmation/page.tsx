...
//
// It renders directly rather than handing off to a client half (the pattern app/page.tsx uses)
// because there is nothing interactive here: the useState/useEffect it used to carry existed
