...
function ConfirmationContent() {
  ...
  // hardcoded sentence "Cancellations must be made at least 7 days before arrival" — Cady's
  // standard policy, printed on every confirmation regardless of the rule that actually
  // applies. A camper arriving on a holiday weekend was told 7 days when their booking is
  // governed by a 30-day rule, and in the template every park told its campers Cady's terms.
  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: 'var(--surface-bg)' }}>
      ...
      <div className="px-4 py-4 flex items-center gap-4" style={{ backgroundColor: 'var(--surface-card)' }}>
        ...
        />
        <div>
          <h1 className="text-[var(--text-primary)] font-bold">Cady Hollow Campground</h1>
      ...
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <div className="text-center space-y-4">
          <p className="text-[var(--text-muted)] text-sm">
            ...
            <a href="mailto:info@cadyhollow.com" style={{ color: 'var(--accent-color)' }}>
              info@cadyhollow.com
            </a>
          </p>
          <Link
