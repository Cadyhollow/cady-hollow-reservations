...
//
// Note this INVERTS the previous default in SquareCardField, which loaded the sandbox SDK for
// any value that was not exactly 'production' — i.e. it failed open to sandbox. Nothing about
