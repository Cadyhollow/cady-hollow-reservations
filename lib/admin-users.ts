...
//
// Security PR 5c-1. This is the durable replacement for scripts/seed-user.mjs: until now the ONLY
// way an account came into existence was someone with the service key running a script by hand.
// That is fine for a bootstrap and hopeless as an operating procedure — Cady cannot add a
// seasonal staff member in April by cloning a repository.
//
