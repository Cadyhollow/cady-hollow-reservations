...
//
// Security PR 5b-2. This module is deliberately pure: no imports, no Supabase, no next/server. It
...
//   * the CHECK constraint on public.profiles.role (PR 5a)
//   * app.at_least() in the database (PR 5b-1), which the RLS policies call
 ...
 * link authorises nothing: middleware.ts refuses the page and requireRole() refuses the route,
