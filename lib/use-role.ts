...
//
// Security PR 5b-2 follow-up. The nav gate shipped first and was not enough: hiding a nav item
...
// requireRole(), the pages with middleware, and the raw PostgREST writes with the 5b-1 RLS
// policies. Editing the response in devtools reveals buttons that then fail at all three.
